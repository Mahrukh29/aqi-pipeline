...
if not HOPSWORKS_API_KEY:
    logging.error("HOPSWORKS_API_KEY is missing! Check GitHub Actions secrets or environment.")
    raise ValueError("Missing HOPSWORKS_API_KEY")
else:
    logging.info(f"Hopsworks API key starts with: {HOPSWORKS_API_KEY[:5]}")  # Optional debug
